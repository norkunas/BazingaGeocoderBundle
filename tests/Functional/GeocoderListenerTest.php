...
final class GeocoderListenerTest extends KernelTestCase
{
    ...
    {
        return new MockHttpClient(static function (string $method, string $url): JsonMockResponse {
                ...
                return new JsonMockResponse([
                    [
                        ...
                        'extratags' => [
                            ...
                            'openGeoDB:loc_id' => '14356',
                            'capital_ISO3166-1' => 'yes',
                            'name:prefix:state' => 'Land',
                            'source:population' => 'https://download.statistik-berlin-brandenburg.de/fa93e3bd19a2e885/a5ecfb2fff6a/SB_A01-05-00_2020h02_BE.pdf',
                            ...
                            'openGeoDB:postal_codes' => '10178,10115,10117,10119,10179,10243,10245,10247,10249,10315,10317,10318,10319,10365,10367,10369,10405,10407,10409,10435,10437,10439,10551,10553,10555,10557,10559,10585,10587,10589,10623,10625,10627,10629,10707,10709,10711,10713,10715,10717,10719,10777,10',
                            'report_problems:website' => 'https://ordnungsamt.berlin.de/',
                            'TMC:cid_58:tabcd_1:Class' => 'Area',
                            'openGeoDB:license_plate_code' => 'B',
                            'TMC:cid_58:tabcd_1:LCLversion' => '12.0',
                            'openGeoDB:telephone_area_code' => '030',
                            'TMC:cid_58:tabcd_1:LocationCode' => '266',
                            'de:amtlicher_gemeindeschluessel' => '11000000',
                            'openGeoDB:community_identification_number' => '11000000',
                        ],
                ...
                return new JsonMockResponse([
                    ...
                    [
                        ...
                        'extratags' => [
                            ...
                            'contact:website' => 'http://www.paris.fr',
                    ...
                    [
                        ...
                        'extratags' => [
                            'wikidata' => 'Q2863958',
                            'ref:INSEE' => '751',
                            'wikipedia' => 'fr:Arrondissement de Paris',
                        ],
                        'boundingbox' => ['48.8155755', '48.9021560', '2.2241220', '2.4697602'],
                    ],
                ]);
    ...
    {
        return new MockHttpClient(static function (string $method, string $url) use (&$requestCount): JsonMockResponse {
