...
final class PluginInteractionTest extends KernelTestCase
{
    ...
    public function testCachePluginUsesIpFromFakeIpPlugin(): void
    {
        ...
        $container->set('http_client', new MockHttpClient(static function (string $method, string $url, array $options): JsonMockResponse {
            ...
            return new JsonMockResponse([
                ...
                'latitude' => 39.907501220703125,
                'longitude' => 116.39710235595703,
                'metro_code' => 0,
            ]);
        }));
